...
sales_router = routers.DefaultRouter()
sales_router.register(r'api/purchase_orders', PurchaseOrderViewSet)
sales_router.register(r'api/vendors/<int:pk>/performance', HistoricalPerformanceViewSet)
